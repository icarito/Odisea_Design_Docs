...
![[enemigo_dron_diagnostico.jpeg]]

| Nombre                                 | Tipo de Amenaza             | Mecánica / Jugabilidad                                                                                                               | Justificación (Falla Simulada)                                                                             |
| -------------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| **Dron de Diagnóstico y Configuración (DDC)** — bajo control de Odisea | Enemigo Común, Rango Corto  | Pequeño y rápido, sigue a Elías para "escanearlo" (daño por pulso electromagnético). Fácil de aplastar o evadir. Mismo hardware que Cargol; la diferencia es de software y control, no de modelo. | Simula un control de calidad fallido que sobrecarga el escaneo.                                            |
...
![[enemigo_brazo_robotico.png]]![[enemigo_torre_purga_aire.jpeg]]![[enemigo_nube_radiacion.png]]![[enemigo_minero_pesado.png]]![[enemigo_trampa_ventilacion.png]]![[enemigo_dron_agresivo.png]]![[enemigo_extra_concept.jpeg]]